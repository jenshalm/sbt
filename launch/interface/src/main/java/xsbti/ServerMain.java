 ...
 * 
 * 1. Expose an HTTP port that clients can connect to, returned via the start method.
...
public interface ServerMain {
   ...
   *      
   *      
   * TODO - Maybe start should return something that has this method
   *        and the URI call as well...
   */
